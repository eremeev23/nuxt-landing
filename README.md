# nuxt-landing
 ...
 Сверстать страницы используя Nuxt.js
 Страница должна подстраиваться под любые разрешения.
 Внешний вид промежуточных разрешений на усмотрение разработчика.

 Шапка должна залипать при скролле
